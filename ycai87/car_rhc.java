...
public class car_rhc {
    private static Instance[] instances = initializeInstances();
    private static Instance[] train_set = Arrays.copyOfRange(instances, 0, 1210);
    private static Instance[] test_set = Arrays.copyOfRange(instances, 1210, 1728);

    private static DataSet set = new DataSet(train_set);

    private static int inputLayer = 6, hiddenLayer= 9, outputLayer = 4;
    ...
    private static Instance[] initializeInstances() {
        ...
        try {
            BufferedReader br = new BufferedReader(new FileReader(new File("src/opt/ycai87/car.data")));
            ...
            for(int i = 0; i < attributes.length; i++) {
                ...
                attributes[i][0] = new double[6]; // 16 attributes
                attributes[i][1] = new double[4]; // classification
